        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/sui.rpc.v2.EventService/ListAuthenticatedEvents",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sui.rpc.v2.EventService", "ListAuthenticatedEvents"),
                );
...
pub mod event_service_server {
    ...
    pub const SERVICE_NAME: &str = "sui.rpc.v2.EventService";
...
pub struct ObjectInclusionProof {
    ...
    pub merkle_proof: ::core::option::Option<::prost::bytes::Bytes>,
    #[prost(uint64, optional, tag = "2")]
...
pub struct GetObjectInclusionProofResponse {
    #[prost(message, optional, tag = "1")]
    pub object_ref: ::core::option::Option<ObjectReference>,
    #[prost(message, optional, tag = "2")]
    pub inclusion_proof: ::core::option::Option<ObjectInclusionProof>,
    #[prost(bytes = "bytes", optional, tag = "3")]
...
pub mod ledger_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sui.rpc.v2.LedgerService/GetObjectInclusionProof",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/sui.rpc.v2.LedgerService/GetObjectInclusionProof" => {
                    #[allow(non_camel_case_types)]
                    struct GetObjectInclusionProofSvc<T: LedgerService>(pub Arc<T>);
                    impl<
                        T: LedgerService,
                    ...
                    for GetObjectInclusionProofSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LedgerService>::get_object_inclusion_proof(
                                        &inner,
                                        request,
                                    )
                                    .await
