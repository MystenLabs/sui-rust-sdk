...
pub mod proof_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sui.rpc.v2.ProofService/GetObjectInclusionProof",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sui.rpc.v2.ProofService", "GetObjectInclusionProof"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod proof_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sui.rpc.v2.ProofService";
