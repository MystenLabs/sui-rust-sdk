pub(crate) mod _field_impls {
    ...
    impl GetOcsInclusionProofRequest {
        pub const OBJECT_ID_FIELD: &'static MessageField = &MessageField {
            name: "object_id",
            json_name: "objectId",
            number: 1i32,
    ...
    impl MessageFields for GetOcsInclusionProofRequest {
        const FIELDS: &'static [&'static MessageField] = &[
    ...
    impl GetOcsInclusionProofRequest {
        pub fn path_builder() -> GetOcsInclusionProofRequestFieldPathBuilder {
            GetOcsInclusionProofRequestFieldPathBuilder::new()
        }
    }
    pub struct GetOcsInclusionProofRequestFieldPathBuilder {
        path: Vec<&'static str>,
    }
    impl GetOcsInclusionProofRequestFieldPathBuilder {
        #[allow(clippy::new_without_default)]
        pub fn new() -> Self {
            Self { path: Default::default() }
        }
        ...
        pub fn object_id(mut self) -> String {
            self.path.push(GetOcsInclusionProofRequest::OBJECT_ID_FIELD.name);
            self.finish()
        }
        pub fn checkpoint(mut self) -> String {
            self.path.push(GetOcsInclusionProofRequest::CHECKPOINT_FIELD.name);
            self.finish()
        }
    }
    impl GetOcsInclusionProofResponse {
    ...
    impl MessageFields for GetOcsInclusionProofResponse {
        const FIELDS: &'static [&'static MessageField] = &[
    ...
    impl GetOcsInclusionProofResponse {
        pub fn path_builder() -> GetOcsInclusionProofResponseFieldPathBuilder {
            GetOcsInclusionProofResponseFieldPathBuilder::new()
        }
    }
    pub struct GetOcsInclusionProofResponseFieldPathBuilder {
        path: Vec<&'static str>,
    }
    impl GetOcsInclusionProofResponseFieldPathBuilder {
        #[allow(clippy::new_without_default)]
        pub fn new() -> Self {
            Self { path: Default::default() }
        }
        ...
        pub fn object_ref(mut self) -> ObjectReferenceFieldPathBuilder {
            self.path.push(GetOcsInclusionProofResponse::OBJECT_REF_FIELD.name);
            ObjectReferenceFieldPathBuilder::new_with_base(self.path)
        }
        pub fn inclusion_proof(mut self) -> OcsInclusionProofFieldPathBuilder {
            self.path.push(GetOcsInclusionProofResponse::INCLUSION_PROOF_FIELD.name);
            OcsInclusionProofFieldPathBuilder::new_with_base(self.path)
        }
        pub fn object_data(mut self) -> String {
            self.path.push(GetOcsInclusionProofResponse::OBJECT_DATA_FIELD.name);
            self.finish()
        }
        pub fn checkpoint_summary(mut self) -> String {
            self.path.push(GetOcsInclusionProofResponse::CHECKPOINT_SUMMARY_FIELD.name);
            self.finish()
        }
    }
    impl QueryOptions {
