...
pub struct SubscribeCheckpointsResponse {
    #[prost(oneof = "subscribe_checkpoints_response::Response", tags = "1, 2")]
    pub response: ::core::option::Option<subscribe_checkpoints_response::Response>,
}
/// Nested message and enum types in `SubscribeCheckpointsResponse`.
pub mod subscribe_checkpoints_response {
    #[non_exhaustive]
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Response {
        /// One matching checkpoint.
...
pub struct SubscribeTransactionsResponse {
    #[prost(oneof = "subscribe_transactions_response::Response", tags = "1, 2")]
    pub response: ::core::option::Option<subscribe_transactions_response::Response>,
}
/// Nested message and enum types in `SubscribeTransactionsResponse`.
pub mod subscribe_transactions_response {
    #[non_exhaustive]
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Response {
        /// One matching transaction.
...
pub struct SubscribeEventsResponse {
    #[prost(oneof = "subscribe_events_response::Response", tags = "1, 2")]
    pub response: ::core::option::Option<subscribe_events_response::Response>,
}
