...
impl serde::Serialize for PackageWriteFilter {
        ...
        S: serde::Serializer,
    {
        ...
        let struct_ser = serializer
            .serialize_struct("sui.rpc.v2alpha.PackageWriteFilter", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter.write_str("struct sui.rpc.v2alpha.PackageWriteFilter")
            }
            fn visit_map<V>(
                self,
                mut map_: V,
        ...
        deserializer
            .deserialize_struct(
                "sui.rpc.v2alpha.PackageWriteFilter",
                FIELDS,
                GeneratedVisitor,
            )
    }
