...
impl EventStreamState {
    ...
    async fn fetch_and_verify_next_batch(
        ...
        loop {
            ...
            let response = {
                ...
                let mut request =
                    sui_rpc::proto::sui::rpc::v2::ListAuthenticatedEventsRequest::default();
    ...
    fn group_events_by_checkpoint(
        ...
        for event in events {
            ...
            let digest = event_digest(&event.event);
